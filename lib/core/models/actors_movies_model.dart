...
class ActorsMoviesModel {
  ...
  ActorsMoviesModel({this.status, this.appUrl, this.data});

  ActorsMoviesModel.fromJson(Map<String, dynamic> json) {
    this._fromJson(json);
  }
  ...
  Future<void> callApi({int id}) async {
    try {
      Map<String, dynamic> res =
          await HttpHelper.get(AppUrls.actorsMoviesUrl + id.toString());
      if (res == null) return;
...
class Pivot {
  ...
  Pivot({this.actorId, this.videoId, this.createdAt, this.updatedAt});
