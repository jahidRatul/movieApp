...
class GenreAllMoviesModel {
  bool status;
  String appUrl;
  Data data;

  GenreAllMoviesModel({this.status, this.appUrl, this.data});

  GenreAllMoviesModel.fromJson(Map<String, dynamic> json) {
    this._fromJson(json);
  }
  ...
  Future<void> callApi(String id) async {
    try {
      Map<String, dynamic> res =
          await HttpHelper.get(AppUrls.genreAllMoviesUrl + id);
      print(res);
